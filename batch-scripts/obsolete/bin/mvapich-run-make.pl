...
my $JOBNAME = "hdfmk".$JNPRT2.$JNPRT3;
...
my $OUTPUT = $OUTPUT_BEGIN.$JOBLINE.$OUTPUT_NEXT1."cd $CALLING_DIR\n".$OUTPUT_NEXT2.$MAKE_COMMAND.$OUTPUT_END;

my $out;
my $outfile = "mvapich-run-".$JOBNAME;
open $out, '>', $outfile;
