...
if [[ $HOSTNAME == summit* ]]; then
    ...
    SKIP_TESTS="'MPI_TEST_testphdf5_cchunk3|MPI_TEST_testphdf5_tldsc|MPI_TEST_testphdf5_ecdsetw|MPI_TEST_testphdf5_eidsetw2|MPI_TEST_t_shapesame|MPI_TEST_t_filters_parallel'"
